...
def download_dem_alternative():
    ...
    if check_gdal():
        ...
        print("  gdal_translate -co COMPRESS=LZW utah_dem.vrt data/raw/utah_dem.tif")
    else:
...
def main():
    ...
    print("This script helps download terrain data for cost-distance analysis.")
    print("Automatic download is currently unreliable, so manual download is recommended.")
